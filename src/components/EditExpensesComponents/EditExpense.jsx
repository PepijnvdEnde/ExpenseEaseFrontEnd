...
const EditExpense = () => {
    return (<>
        ...
        <div className="max-h-96 overflow-y-auto">
            <EditExpenseRow amount="3,29" description="Lunch" catagory="Food & Dining" date="10-03-2024" />
            <EditExpenseRow amount="16,24" description="Trein tickets" catagory="Transportation" date="05-04-2024" />
            <EditExpenseRow amount="3,68" description="Plus run" catagory="Groceries" date="01-05-2024" />
            <EditExpenseRow amount="10,99" description="Film" catagory="Entertainment" date="10-06-2024" />
            <EditExpenseRow amount="120,23" description="Rent 05/04/2024" catagory="Rent" date="15-07-2024" />
            <EditExpenseRow amount="12,54" description="Haar gel" catagory="Health" date="20-08-2024" />
            <EditExpenseRow amount="90,54" description="Schoenen" catagory="Shopping" date="25-09-2024" />
            <EditExpenseRow amount="523,87" description="vakantie 2024" catagory="Travel" date="30-10-2024" />
            <EditExpenseRow amount="2,39" description="chips" catagory="Personal Care" date="05-11-2024" />
