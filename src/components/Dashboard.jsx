...
import ExpenseHistory from './History-Components/ExpenseHistory';
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center w-screen min-h-screen bg-white pt-2">
                ...
                <div className="w-3/4 flex flex-col justify-center items-center border-2 border-black h-min p-3 mb-3">
                    <div className="text-4xl w-full text-center pb-3 border-b-2 border-black">Summary</div>
                    <p className="text-4xl"> Spent: 300.00</p>
                </div>
